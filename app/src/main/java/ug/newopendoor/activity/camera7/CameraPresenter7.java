...
public class CameraPresenter7 extends BasePresenter implements CameraContract7.Presenter {
    private CameraContract7.View view;

    public CameraPresenter7(CameraContract7.View view) {
        this.view = view;
